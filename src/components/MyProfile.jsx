    ...
    <div className="flex justify-center items-center  ">
      {!editMode && (
        ...
        <div className='flex flex-col justify-start items-start px-20 py-10'>
         <h2 className='bg-gray-300 text-start p-3 rounded-lg w-1/3 m-2 flex'> <p className='mx-2 font-semibold'>Name:</p> {name} </h2>
         <h2 className='bg-gray-300 text-start p-3 rounded-lg w-1/3 m-2 flex'> <p className='mx-2 font-semibold'>Role:</p> {role} </h2>
         <h2 className='bg-gray-300 text-start p-3 rounded-lg w-1/3 m-2 flex'> <p className='mx-2 font-semibold'>location: </p>{location} </h2>
        </div>
      </div>)}
      {editMode && (
